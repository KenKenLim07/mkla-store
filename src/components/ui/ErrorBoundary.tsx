            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-pink-600 text-white px-4 py-2 rounded-md hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 transition-colors"
                >
                  Try Again
                </button>
                <button
