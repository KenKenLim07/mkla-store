        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:flex items-center space-x-1 ml-10">
              <Link
                to="/"
                className="text-gray-700 hover:text-pink-600 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:bg-pink-50 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 relative group"
              >
              ...
              {user?.role === 'admin' && (
                <div className="relative">
                  ...
                  >
                    <Link
                      to="/admin"
                      className="block px-4 py-3 text-sm text-gray-700 hover:bg-pink-50 hover:text-pink-600 transition-all duration-300 rounded-lg mx-2"
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="text-gray-700 hover:text-pink-600 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 transition-all duration-300 hover:bg-pink-50"
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-100 shadow-xl animate-slide-down">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
              to="/"
              className="text-gray-700 hover:text-pink-600 block px-3 py-3 rounded-lg text-base font-medium transition-all duration-300 hover:bg-pink-50"
            ...
            <div className="border-t border-gray-100 pt-4 mt-4">
              {user ? (
                <div className="space-y-2">
                  ...
                  <button
                    onClick={handleSignOut}
                    className="text-gray-700 hover:text-pink-600 block w-full text-left px-3 py-3 rounded-lg text-base font-medium transition-all duration-300 hover:bg-pink-50"
                  >
                    Sign Out
                  </button>
                </div>
